/*
  ...
  1. Changes
    ...
    - Insert default workout templates (Full Body, Lower Body + Core, Upper Body + Core)
    - Add template exercises with proper order and default sets/reps
    - Templates are marked as default and visible to all users
  ...
  2. Data
    - Templates:
      ...
      - Lower Body + Core
      - Upper Body + Core
    - Each template includes exercises with specific sets, reps, and order
*/

-- Create a system user for default templates
INSERT INTO auth.users (id, email)
VALUES ('00000000-0000-0000-0000-000000000000', 'system@workoutapp.local')
